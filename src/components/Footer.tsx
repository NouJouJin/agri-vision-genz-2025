        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>
                <a href="#entries" className="hover:text-green-400 transition-colors">
                  応募作品
                </a>
              </li>
              <li>
                <a href="#guidelines" className="hover:text-green-400 transition-colors">
                  応募要項
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Twitter"
              >
                <svg className="w-5 h-5 text-gray-400 hover:text-green-400" fill="currentColor" viewBox="0 0 24 24">
